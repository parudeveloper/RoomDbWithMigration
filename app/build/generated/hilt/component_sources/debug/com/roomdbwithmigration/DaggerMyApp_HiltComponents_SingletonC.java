package com.roomdbwithmigration;
...
import com.roomdbwithmigration.di.DatabaseModule_ProvideDatabaseFactory;
import com.roomdbwithmigration.di.DatabaseModule_ProvideStudentDaoFactory;
...
import com.roomdbwithmigration.ui.MainActivity;
import com.roomdbwithmigration.viewmodel.StudentViewModel;
import com.roomdbwithmigration.viewmodel.StudentViewModel_HiltModules;
import com.roomdbwithmigration.viewmodel.StudentViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.roomdbwithmigration.viewmodel.StudentViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
public final class DaggerMyApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MyApp_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(StudentViewModel_HiltModules_KeyModule_Provide_LazyMapKey.lazyClassKeyName, StudentViewModel_HiltModules.KeyModule.provide()));
    }
  ...
  private static final class ViewModelCImpl extends MyApp_HiltComponents.ViewModelC {
    ...
    Provider<StudentViewModel> studentViewModelProvider;
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.studentViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
    }

    @Override
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(StudentViewModel_HiltModules_BindsModule_Binds_LazyMapKey.lazyClassKeyName, ((Provider) (studentViewModelProvider))));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.roomdbwithmigration.viewmodel.StudentViewModel
          return (T) new StudentViewModel(singletonCImpl.studentRepositoryProvider.get());
  ...
  private static final class SingletonCImpl extends MyApp_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.studentRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<StudentRepository>(singletonCImpl, 0));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.roomdbwithmigration.repo.StudentRepository
          return (T) new StudentRepository(singletonCImpl.studentDao());

          case 1: // com.roomdbwithmigration.localdb.AppDatabase
